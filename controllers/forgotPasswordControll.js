...
exports.forgotPasswordController = async (req, res) => {
  try {
    ...
    const uuid = uuidv4();
    const resultAfterSendingEmail =
      await new SendinblueApiV3Sdk.TransactionalEmailsApi().sendTransacEmail({
        subject: subject,
        sender: sender,
        to: toEmail,
    ...
    console.log(
      "result after table is created",
      resultCreateForgotPasswordTable
    );
    return res
      .status(200)
